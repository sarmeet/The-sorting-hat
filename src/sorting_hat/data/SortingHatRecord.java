...
public class SortingHatRecord
{
    ...
    /**
     * This method adds a perfect win top the current player's record 
     * to the level being played. 
     */
    ...
    public void addPerfectWinTime(long mill, String perfectTimeString,  String levelName){
        
         SortingHatLevelRecord rec = levelRecords.get(levelName);
        if ( rec.perfectMilisecs == 0){
            rec.perfectMilisecs = mill;
            rec.perfetTime = perfectTimeString;
        }
        else{
            if ( rec.perfectMilisecs >mill){
                rec.perfectMilisecs = mill;
                rec.perfetTime = perfectTimeString;
            }
        }
...
public String getPerfectWinsTime(String levelName)
    {
        SortingHatLevelRecord rec = levelRecords.get(levelName);
    ...
    public byte[] toByteArray() throws IOException
    {
        ...
        while(keysIt.hasNext())
        {
            ...
            dos.writeUTF(rec.perfetTime);
            dos.writeLong(rec.perfectMilisecs);
