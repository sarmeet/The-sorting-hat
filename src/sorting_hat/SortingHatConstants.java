...
public class SortingHatConstants
{
    ...
    public static final int BACK_BUTTON_X = NEW_BUTTON_X+130;
    ...
    public static final int UNDO_BUTTON_X = STATS_X+160;
    public static final int UNDO_BUTTON_Y = 0;
    public static final int ALGORITHM_TILE_X = UNDO_BUTTON_X + 130 + CONTROLS_MARGIN;
    public static final int ALGORITHM_TILE_Y = 0;
    public static final int ALGORITHM_DISPLAY_OFFSET_X = 30;
    public static final int ALGORITHM_DISPLAY_OFFSET_Y = 45;
    ...
    public static final int WIN_PATH_NODES = 10;
    ...
    public static final Font FONT_ALGORITHM_DISPLAY = new Font(Font.MONOSPACED, Font.BOLD, 15);
}