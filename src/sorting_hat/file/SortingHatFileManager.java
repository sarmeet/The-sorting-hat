 ...
 * for The Sorting Hat game application.
 *
...
public class SortingHatFileManager {
    ...
    public void loadLevel(String levelFile) {
        ...
        try {
            ...
            int minCol = initSnakeLength;
            int maxCol = 0;
            int minRow = initSnakeLength;
            int maxRow = 0;
     ...
     *
     * @param record The complete player record, which has the records on all
     * levels.
     */
    public void saveRecord(SortingHatRecord record) {
        try {
            ...
            System.out.println("boo. file write failed");
        }
    }
    ...
    public SortingHatRecord loadRecord() {
        ...
        try {
            ...
            for (int i = 0; i < numLevels; i++) {
                ...
                rec.perfetTime = dis.readUTF();
                rec.perfectMilisecs = dis.readLong();
