...
public class SortingHatMiniGame extends MiniGame
{
	...
	img = loadImage(imgPath + UndoButton);
        ...
        sT.addState(SortingHatTileState.VISIBLE_STATE.toString(), img);
        s = new Sprite(sT, ALGORITHM_TILE_X, ALGORITHM_TILE_Y, 0, 0, SortingHatTileState.INVISIBLE_STATE.toString());
    ...
    public void initGUIHandlers()
    {
        ...
        guiButtons.get(BACK_BUTTON_TYPE).setActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                eventHandler.respondToBackButtonRequest();
            }
        });
        ...
        guiButtons.get(UNDO_BUTTON_TYPE).setActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                eventHandler.respondToUndoButtonRequest();
            }
        });
    ...
    public void reset()
    {
                        getAudio().stop(TheSortingHat.SortingHatPropertyType.AUDIO_CUE_WIN.toString());
                        getAudio().play(SortingHatPropertyType.SONG_CUE_GAME_SCREEN.toString(), false);
